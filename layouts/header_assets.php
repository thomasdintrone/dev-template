...
<!-- FONTS -->
<link href="<?php echo SITE_ROOT; ?>css/fonts/font-awesome-4.2.0 2/css/font-awesome.min.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">

<!-- CSS -->
<link href="<?php echo SITE_ROOT; ?>style.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="<?php echo SITE_ROOT; ?>css/responsive.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="<?php echo SITE_ROOT; ?>css/browsers.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="<?php echo SITE_ROOT; ?>css/devices.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="<?php echo SITE_ROOT; ?>css/animate.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
...
<link href="<?php echo SITE_ROOT; ?>css/developer1.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<!--<link href="css/developer2.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="css/developer3.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<link href="css/developer4.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">-->

<!-- PLUGINS CSS -->
<?php $plugins->load_plugin_css(); ?>

<!--[if IE 9]>
	<link href="<?php echo SITE_ROOT; ?>css/ie9.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<![endif]-->

<!--[if IE 8]>
	<link href="<?php echo SITE_ROOT; ?>css/ie8.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<![endif]-->

<!--[if IE 7]>
	<link href="<?php echo SITE_ROOT; ?>css/ie7.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<![endif]-->
...
<!--[if lt IE 9]>
	...
	<link href="<?php echo SITE_ROOT; ?>css/ie.css<?php echo UNCACHE; ?>" type="text/css" rel="stylesheet">
<![endif]-->

<!-- MODERNIZR -->
<script type="text/javascript" src="<?php echo SITE_ROOT; ?>js/modernizr.js<?php echo UNCACHE; ?>"></script>
