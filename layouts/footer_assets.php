...
<!--[if (gte IE 6)&(lte IE 8)]>
  <script type="text/javascript" src="<?php echo SITE_ROOT; ?>js/selectivizr/selectivizr-min.js"></script>
...
<script type="text/javascript" src="<?php echo SITE_ROOT; ?>js/form-submit.js"></script>